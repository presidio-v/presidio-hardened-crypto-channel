# Maintenance Policy — presidio-hardened-crypto-channel

**Status: Frozen — security-fixes-only** (as of 2026-06-11).

`presidio-hardened-crypto-channel` is published to PyPI and feature-complete for its scope. It
...
```bash
pip install presidio-hardened-crypto-channel
```
